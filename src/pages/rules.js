...
const RulesPage = () => (
  <Layout>
    <PageShell title={"Rules"} lead={"How to play the game"}>
      <hr className="site-hr" />
      <div className="flow">
      <h2>Equipment</h2>
      <p className="text-muted-foreground">What you need to play</p>
      <h3>5 dice</h3>
      <p>
        We prefer Michigan Red Eye's but any die will do. The red eye's make it a little faster to see what game you can play.
      </p>
      <a className="inline-block btn-primary" role="button" href="https://amzn.to/47ZTYoX">Buy Michigan Red Eye Dice on Amazon</a>
      <h3>Dice cup</h3>
      <p>
      ...
      <a className="inline-block btn-primary" role="button" href="https://amzn.to/3w0X0w6">Buy Alex Cramer dice cups on Amazon</a>
      </div>
      <div className="flow">
      <h2>Object of the game</h2>
      <p className="text-muted-foreground">Be the last man standing</p>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Alert variant="success">
          ...
          <p>The score:</p>
          <ListGroup>
            <ListGroupItem>👨 has ✏️✏️ and the <Link to="/glossary#hammer"><span role="img" aria-label="hammer">🔨</span></Link></ListGroupItem>
            <ListGroupItem>👩 has ✏️</ListGroupItem>
          </ListGroup>
          <p>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="card bg-success-surface">
          <h5 className="font-semibold">Example</h5>
          <p>
      ...
      <div className="card bg-success-surface p-4">
        <h5 className="font-semibold">Example</h5>
        <p>
      ...
      <div className="grid md:grid-cols-4 gap-6">
        <Card>
          <h4 className="text-lg font-semibold" id="first-call">First Call</h4>
          <div className="text-sm text-muted-foreground">Aka "the hammer" <Link to="/glossary#hammer"><span role="img" aria-label="hammer">🔨</span></Link></div>
              <p className="mt-2 text-surface-foreground">Whomever has the <Link to="/glossary#hammer"><span role="img" aria-label="hammer">🔨</span></Link> looks at their hand and calls out a game they wish to play first knowing that the player directly to their left has the right of <em>first refusal</em>.</p>
          <ListGroup className="mt-3">
            <ListGroupItem><Link to="/games">Call a game</Link> → <Link to="/rules#first-refusal">First Refusal</Link></ListGroupItem>
            <ListGroupItem><Link to="/glossary#bark">Bark</Link> → Game ends and Hammer passes to the left</ListGroupItem>
          </ListGroup>
        </Card>
        <Card>
          <h4 className="text-lg font-semibold" id="first-refusal">First Refusal</h4>
          <div className="text-sm text-muted-foreground">First player to the callers left</div>
          <p className="mt-2 text-surface-foreground">The player to the caller's immediate left looks at her dice and determines if she can play the game or not. If she can, she should accept and say, "I'll play". If she cannot, she says, "No".</p>
          <ListGroup className="mt-3">
            <ListGroupItem><Link to="/rules#second-refusal">Refuse</Link> → <Link to="/rules#second-refusal">Second Refusal</Link></ListGroupItem>
            <ListGroupItem><Link to="/rules#play-game">Accept</Link> → <Link to="/rules#play-game">Play game</Link></ListGroupItem>
          </ListGroup>
        </Card>
        <Card>
          <h4 className="text-lg font-semibold" id="second-refusal">Second Refusal</h4>
          <div className="text-sm text-muted-foreground">Second player to the callers left</div>
          <p className="mt-2 text-surface-foreground">The second player to the hammer's left can "Accept" or "Refuse" the call. If she accepts, then everyone plays. If she refuses the hammer must call their second and final call.</p>
          <ListGroup className="mt-3">
            <ListGroupItem><Link to="/glossary#refuse">Refuse</Link> → <Link to="/rules#second-call">Second Call</Link></ListGroupItem>
            <ListGroupItem><Link to="/glossary#accept">Accept</Link> → <Link to="/rules#play-game">Play game</Link></ListGroupItem>
          </ListGroup>
        </Card>
        <Card>
          <h4 className="text-lg font-semibold" id="second-call">Second Call</h4>
          <div className="text-sm text-muted-foreground">No refusal!</div>
          <p className="mt-2 text-surface-foreground">If the first call was refused, all players must play the callers second game.</p>
          <ListGroup className="mt-3"><ListGroupItem><Link to="/rules#play-game">Play game</Link></ListGroupItem></ListGroup>
        </Card>
      </div>
      ...
      <Alert className="mt-4">
        <h5 className="font-semibold">Ties</h5>
        <p>
        ...
        <h5 className="font-semibold">Exception: <small>2 players <span role="img" aria-label="player">👨</span><span role="img" aria-label="player">👨</span></small></h5>
      ...
      <Alert className="mt-4">
        <h5 className="font-semibold">3 <span role="img" aria-label="pencil">✏️</span>'s</h5>
        <p>

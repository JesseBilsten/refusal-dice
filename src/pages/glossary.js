...
export default () => (
  <Layout>
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <h2 id="bark" className="text-3xl font-semibold mb-2 mt-6 text-gray-900">
        Bark <small className="text-gray-600">you ain't got <span role="img" aria-label="poop">💩</span></small>
      </h2>
      <p>
        If you don't have a good hand on your First Call, you can choose to
        "Bark" and give the hammer to the player to your left.
      </p>
      <h2 id="frankie" className="text-3xl font-semibold mb-2 mt-6 text-gray-900">
        Frankie{' '}
      ...
      <h2 id="hammer" className="text-3xl font-semibold mb-2 mt-6 text-gray-900">
        Hammer <small className="text-gray-600">the play caller <span role="img" aria-label="hammer">🔨</span></small>
      </h2>
      <p>
      ...
      <h2 id="parity" className="text-3xl font-semibold mb-2 mt-6 text-gray-900">
        Parity <small className="text-gray-600">2 <span role="img" aria-label="pencil">✏️</span>'s</small>
      </h2>
      <p>
